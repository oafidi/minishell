...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/18 13:38:33 by yettalib          #+#    #+#             */
/*   Updated: 2025/08/18 18:09:55 by oafidi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	execute_command(t_cmd *cmd_head, \
		char **herdocs, t_env **env, int herdocs_count);
...
char	*handle_heredoc_input(t_redir *redir, \
			char **heredocs, t_env *env, int index);
...
void	run_pipeline(t_cmd *cmd, char **herdocs, \
			t_env **env, int heredoc_count);
...
t_cmd	*init_command_parsing(t_global_struct *global_struct);
...
char	*expand(char *line, t_global_struct *global_struct, \
		int start_quote_state);
int		expand_line(t_cmd *cmd, t_global_struct *global_struct);
